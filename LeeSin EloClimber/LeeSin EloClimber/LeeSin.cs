...
namespace LeeSin_EloClimber
{
    internal class LeeSin
    {
        ...
        internal static Obj_AI_Hero myHero;
        ...
        internal static void Load()
        {
            ...
            Obj_AI_Base.OnBuffUpdateCount += OnBuffUpdateCount;
        ...
        private static void Obj_AI_Base_OnCreate(GameObject obj, EventArgs args)
        {
            ...
            if (W.IsReady() && obj.Name.ToLower().Contains("ward"))
            {
        ...
        private static void OnBuffUpdateCount(Obj_AI_Base sender, Obj_AI_BaseBuffUpdateCountEventArgs Args)
        {
            if (sender.IsMe && Args.Buff.Name == "blindmonkpassive_cosmetic")
                PassiveStack = 1;
        }
